...
pub fn ros2_msg_to_agent_msg(msg: ros_agent_msgs::msg::AgentMessage) -> Option<botbrain::Message> {
...
pub fn agent_msg_to_ros2_msg(msg: botbrain::Message) -> Option<ros_agent_msgs::msg::AgentMessage> {
