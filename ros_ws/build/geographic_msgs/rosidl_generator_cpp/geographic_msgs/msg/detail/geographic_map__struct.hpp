...
// IWYU pragma: private, include "geographic_msgs/msg/geographic_map.hpp"
...
struct GeographicMap_
{
  ...
  using _features_type =
    std::vector<geographic_msgs::msg::MapFeature_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<geographic_msgs::msg::MapFeature_<ContainerAllocator>>>;
  ...
  Type & set__features(
    const std::vector<geographic_msgs::msg::MapFeature_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<geographic_msgs::msg::MapFeature_<ContainerAllocator>>> & _arg)
  {
    this->features = _arg;
    return *this;
  }
