...
// IWYU pragma: private, include "geographic_msgs/msg/route_network.hpp"
...
struct RouteNetwork_
{
  ...
  _bounds_type bounds;
  using _points_type =
    std::vector<geographic_msgs::msg::WayPoint_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<geographic_msgs::msg::WayPoint_<ContainerAllocator>>>;
  _points_type points;
  using _segments_type =
    std::vector<geographic_msgs::msg::RouteSegment_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<geographic_msgs::msg::RouteSegment_<ContainerAllocator>>>;
  _segments_type segments;
  using _props_type =
    std::vector<geographic_msgs::msg::KeyValue_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<geographic_msgs::msg::KeyValue_<ContainerAllocator>>>;
  _props_type props;
  ...
  Type & set__points(
    const std::vector<geographic_msgs::msg::WayPoint_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<geographic_msgs::msg::WayPoint_<ContainerAllocator>>> & _arg)
  {
    this->points = _arg;
    return *this;
  }
  Type & set__segments(
    const std::vector<geographic_msgs::msg::RouteSegment_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<geographic_msgs::msg::RouteSegment_<ContainerAllocator>>> & _arg)
  {
    this->segments = _arg;
    return *this;
  }
  Type & set__props(
    const std::vector<geographic_msgs::msg::KeyValue_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<geographic_msgs::msg::KeyValue_<ContainerAllocator>>> & _arg)
  {
    this->props = _arg;
    return *this;
  }
