...
bool cdr_serialize_geographic_msgs__srv__GetGeographicMap_Request(
  const geographic_msgs__srv__GetGeographicMap_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: url
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geographic_msgs
bool cdr_deserialize_geographic_msgs__srv__GetGeographicMap_Request(
  eprosima::fastcdr::Cdr & cdr,
  geographic_msgs__srv__GetGeographicMap_Request * ros_message)
{
  // Field name: url
  {
    std::string tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geographic_msgs
bool cdr_serialize_key_geographic_msgs__srv__GetGeographicMap_Request(
  const geographic_msgs__srv__GetGeographicMap_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: url
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geographic_msgs
size_t get_serialized_size_key_geographic_msgs__srv__GetGeographicMap_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetGeographicMap_Request__ros_msg_type * ros_message = static_cast<const _GetGeographicMap_Request__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geographic_msgs
size_t max_serialized_size_key_geographic_msgs__srv__GetGeographicMap_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const geographic_msgs__srv__GetGeographicMap_Request * ros_message = static_cast<const geographic_msgs__srv__GetGeographicMap_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_geographic_msgs__srv__GetGeographicMap_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  geographic_msgs__srv__GetGeographicMap_Request * ros_message = static_cast<geographic_msgs__srv__GetGeographicMap_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_geographic_msgs__srv__GetGeographicMap_Request(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geographic_msgs
bool cdr_serialize_geographic_msgs__srv__GetGeographicMap_Response(
  const geographic_msgs__srv__GetGeographicMap_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: success
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geographic_msgs
bool cdr_deserialize_geographic_msgs__srv__GetGeographicMap_Response(
  eprosima::fastcdr::Cdr & cdr,
  geographic_msgs__srv__GetGeographicMap_Response * ros_message)
{
  // Field name: success
  {
    uint8_t tmp;
  ...
  // Field name: map
  {
    cdr_deserialize_geographic_msgs__msg__GeographicMap(cdr, &ros_message->map);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geographic_msgs
bool cdr_serialize_key_geographic_msgs__srv__GetGeographicMap_Response(
  const geographic_msgs__srv__GetGeographicMap_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: success
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geographic_msgs
size_t get_serialized_size_key_geographic_msgs__srv__GetGeographicMap_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetGeographicMap_Response__ros_msg_type * ros_message = static_cast<const _GetGeographicMap_Response__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geographic_msgs
size_t max_serialized_size_key_geographic_msgs__srv__GetGeographicMap_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const geographic_msgs__srv__GetGeographicMap_Response * ros_message = static_cast<const geographic_msgs__srv__GetGeographicMap_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_geographic_msgs__srv__GetGeographicMap_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  geographic_msgs__srv__GetGeographicMap_Response * ros_message = static_cast<geographic_msgs__srv__GetGeographicMap_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_geographic_msgs__srv__GetGeographicMap_Response(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geographic_msgs
bool cdr_serialize_geographic_msgs__srv__GetGeographicMap_Event(
  const geographic_msgs__srv__GetGeographicMap_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_geographic_msgs__srv__GetGeographicMap_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_geographic_msgs__srv__GetGeographicMap_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geographic_msgs
bool cdr_deserialize_geographic_msgs__srv__GetGeographicMap_Event(
  eprosima::fastcdr::Cdr & cdr,
  geographic_msgs__srv__GetGeographicMap_Event * ros_message)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_geographic_msgs__srv__GetGeographicMap_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_geographic_msgs__srv__GetGeographicMap_Response(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geographic_msgs
bool cdr_serialize_key_geographic_msgs__srv__GetGeographicMap_Event(
  const geographic_msgs__srv__GetGeographicMap_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_geographic_msgs__srv__GetGeographicMap_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_geographic_msgs__srv__GetGeographicMap_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geographic_msgs
size_t get_serialized_size_key_geographic_msgs__srv__GetGeographicMap_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetGeographicMap_Event__ros_msg_type * ros_message = static_cast<const _GetGeographicMap_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_geographic_msgs__srv__GetGeographicMap_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_geographic_msgs__srv__GetGeographicMap_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_geographic_msgs
size_t max_serialized_size_key_geographic_msgs__srv__GetGeographicMap_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_geographic_msgs__srv__GetGeographicMap_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_geographic_msgs__srv__GetGeographicMap_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const geographic_msgs__srv__GetGeographicMap_Event * ros_message = static_cast<const geographic_msgs__srv__GetGeographicMap_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_geographic_msgs__srv__GetGeographicMap_Event(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  geographic_msgs__srv__GetGeographicMap_Event * ros_message = static_cast<geographic_msgs__srv__GetGeographicMap_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_geographic_msgs__srv__GetGeographicMap_Event(cdr, ros_message);
}
