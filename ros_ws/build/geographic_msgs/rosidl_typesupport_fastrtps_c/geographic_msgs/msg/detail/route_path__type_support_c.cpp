  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const geographic_msgs__msg__RoutePath * ros_message = static_cast<const geographic_msgs__msg__RoutePath *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_geographic_msgs__msg__RoutePath(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  geographic_msgs__msg__RoutePath * ros_message = static_cast<geographic_msgs__msg__RoutePath *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_geographic_msgs__msg__RoutePath(cdr, ros_message);
}
