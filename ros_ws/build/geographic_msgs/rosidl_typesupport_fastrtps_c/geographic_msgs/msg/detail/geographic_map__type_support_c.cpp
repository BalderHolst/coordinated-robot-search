...
bool cdr_serialize_geographic_msgs__msg__MapFeature(
  const geographic_msgs__msg__MapFeature * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_geographic_msgs__msg__MapFeature(
  eprosima::fastcdr::Cdr & cdr,
  geographic_msgs__msg__MapFeature * ros_message);
...
bool cdr_serialize_key_geographic_msgs__msg__MapFeature(
  const geographic_msgs__msg__MapFeature * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_geographic_msgs__msg__MapFeature(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_geographic_msgs__msg__MapFeature(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: features
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_geographic_msgs__msg__MapFeature(
        &array_ptr[i], cdr);
    }
  }
  ...
  geographic_msgs__msg__GeographicMap * ros_message)
{
  ...
  // Field name: features
  {
    ...
    auto array_ptr = ros_message->features.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_geographic_msgs__msg__MapFeature(cdr, &array_ptr[i]);
    }
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: features
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_geographic_msgs__msg__MapFeature(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: features
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_geographic_msgs__msg__MapFeature(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: features
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_geographic_msgs__msg__MapFeature(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const geographic_msgs__msg__GeographicMap * ros_message = static_cast<const geographic_msgs__msg__GeographicMap *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_geographic_msgs__msg__GeographicMap(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  geographic_msgs__msg__GeographicMap * ros_message = static_cast<geographic_msgs__msg__GeographicMap *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_geographic_msgs__msg__GeographicMap(cdr, ros_message);
}
