...
The following pages contain a rendered version of the \texttt{README.md} file from the GitHub repository. It contains a description of the project structure, and how to run the code.
