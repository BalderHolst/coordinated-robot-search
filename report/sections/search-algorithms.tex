...
% TODO: Remove no forward bias image, move to Gradient behavior section as an illustation of the search grid as the behavior is run.
\begin{figure}[H]
  \centering
...
% TODO: Explain the elements of the figure well
\begin{figure}[H]
    \begin{center}
...
% TODO: Put the search grid figure here and explain it

To improve coverage, mechanisms that encourage movement toward globally unexplored areas would be beneficial.

\subsection{Global Planner}
% TODO: Cite resources used for devlopment of the planner: A* and frontier exploration
...
% TODO: Remove "pathing-" from legend
% TODO: Tweak `figsize`
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.45\textwidth}
...
% TODO: "An experiment was conducted to..."
% TODO: Move sXX to figure caption
...
% TODO: Mention how everything that came before can be seen
\begin{figure}[H]
  \begin{center}
...
% TODO: Describe more "what" and "why"
