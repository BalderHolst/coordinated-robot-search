...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\textwidth]{figures/rl/minimal-network.png}
    \caption{TODO}
    \label{fig:rl-minimal-net}
\end{figure}

\Cref{fig:rl-minimal-training} shows the training progress of the agent. The agent is able to learn to avoid walls at it is punished for running into walls.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\textwidth]{figures/rl/minimal-training.png}
    \caption{TODO}
    \label{fig:rl-minimal-training}
\end{figure}

% TODO: Write more about the graphs when they are made
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\textwidth]{figures/rl/search-network.png}
    \caption{TODO}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\textwidth]{figures/rl/search-training.png}
    \caption{TODO}
