...
def generate_launch_description():
    ...
    urdflaunch_dir = get_package_share_directory("urdflaunch")
    ...
    set_env_vars_resources2 = AppendEnvironmentVariable(
        "GZ_PLUGIN_PATH", os.path.join(desc_dir)
    )
    ...
    gz_robot = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(urdflaunch_dir, "launch", "spawn_tb4.launch.py")
        ),
        launch_arguments={
            "namespace": namespace,
            "use_simulator": use_simulator,
            "use_sim_time": use_sim_time,
            "robot_name": "testtesttest",
            "robot_sdf": robot_sdf,
            "x_pose": pose["x"],
            "y_pose": pose["y"],
            "z_pose": pose["z"],
